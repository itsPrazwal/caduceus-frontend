...
const EnterPasswordForm:FC<EnterPasswordFormProps> = ({ submitForm, propError }) => {
  ...
  return (
    <form name='change password' onSubmit={handleFinish}>
      ...
      />
      <Button type='submit' disabled={errorState ? Object.keys(errorState).length > 0 : false} >Submit</Button>
    </form>
  )
}
